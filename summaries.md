...
|	5	|	F	|	2/15	| QR Applications, SVD|<li> C. The SVD: Strang mentions the SVD in Chapter 7.  I find the definition in terms of AᵀA a mixed bag.  It's straightforward if you know eigenvalues, but the SVD's true identity is lost in the  eigenworld.  I will not follow the eigenworld approach. </li>| [HW2](http://localhost:8890/notebooks/git/1806/psets/pset2.ipynb) released 2/14.|
|	6	|	T	|	2/19 (Pres Day+1)	|
|	7	|	W	|	2/20	|||HW2 due |
|	8	|	F	|	2/22	|
|	9	|	M	|	2/25	||
