...
|	5	|	F	|	2/15	| QR Applications, SVD|<li> C. The SVD: Strang mentions the SVD in Chapter 7.  I find the definition in terms of AᵀA a mixed bag.  It's straightforward if you know eigenvalues, but the SVD's true identity is lost in the  eigenworld.  I will not follow the eigenworld approach. </li>| [HW2](https://nbviewer.jupyter.org/github/mitmath/1806/blob/master/psets/pset2.ipynb?flush_cache=true) released 2/14.|
|	6	|	T	|	2/19 (Pres Day+1)	|
|	7	|	W	|	2/20	|||HW2 due |
|	8	|	F	|	2/22	|
|	9	|	M	|	2/25	||
|	10	|	W	|	2/27	|review||shorter HW 3 due|
|	11	|	F	|	3/1	| **Exam 1** Walker, during lecture hour,  closed book, grades visible probably in 24 hours,  no exam makeup (paper alternative) |
|	12	|	M	|	3/4	|
|	13	|	W	|	3/6	|||HW 4 due|
|	14	|	F	|	3/8 (add date)	|
|	15	|	M	|	3/11	|
