...
<li> [Julia SVD Image Demo][svdimagejulia] </li> <li> [Cleve Moler tribute to Gene Golub "Professor SVD"][svdgolub] </li><li>  Human walking motion: ([Demo][svd_walking_demo])([Paper][svd_walking_paper]) </li>
<li> [SVD for genome processing paper][svd_genome]</li> </ul> |
|10| M |2/24|
