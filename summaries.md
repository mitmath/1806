...
|0||| Not a Pre-req | We assume no familiarity with computing or Julia.  Some homework problems will use Julia as a calculator. This is not a programming class. On occasion, Julia programming may be demonstrated if it helps understand
linear algebra, but Julia syntax will never be tested.  Tests will be traditional paper and pencil. | Try logging into [Juliabox](http://www.juliabox.com)  and typing the commands in Section 1.1  pages 1,2,and 3 (pdf pages 11-13)  of the [VMLS Julia Companion](http://vmls-book.stanford.edu/vmls-julia-companion.pdf).  If this is painless, then you will be okay for the rest of the semester.  |
